...
def identity_detail(a: str, b: str, threshold: float = .4) -> dict:
    ...
    return dict(identity=nw_identity(a, b, saturation_message="Alignment saturation"),
                coverage=coverage, length_gated=False)
...
def main(argv=None) -> int:
    ...
    from nanoqc.common.repo_io import atomic_write_json_fsync as _ablation_atomic_json, sha256_file as _ablation_digest, repo_path
