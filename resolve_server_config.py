...
def main() -> int:
    ...
    p.add_argument("--scientific-config",type=Path,default=REPO_ROOT/"full_experiment_config.yaml")
    p.add_argument("--server-config",type=Path,default=REPO_ROOT/"server_config.yaml")
