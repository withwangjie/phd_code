...
Run with: pytest tests/test_audit_remediation.py -v
"""
...
import nanoqc.structure.evaluate_complex_metrics as ecm
import nanoqc.solvers.qaoa_interface_sampler as qis
import nanoqc.qubo.subgraph_to_qubo as stq
import nanoqc.pipeline.run_full_experiment as rfe
import nanoqc.experiments.batch_benchmark_hard_set as bbh
import nanoqc.inference.analyze_structure_recovery as asr
import nanoqc.data.build_independence_cluster_map as bicm
import nanoqc.model.train_egnn_pruning as tep
...
def test_trajectory_integration() -> None:
    ...
    with patch("nanoqc.structure.evaluate_complex_metrics.read_structure_atoms", side_effect=read_sequence):
