...
def evaluate_atomistic_prediction(
    ...
    from evaluate_complex_metrics import evaluate_complex_metrics_from_atoms as _evaluate_complex_metrics_from_atoms
    ...
    from structural_quality import docking_quality as _legacy_docking_quality
